...
<head>
    ...
    <title>简约图库</title>
    <!-- 样式表 -->
    <link rel="stylesheet" type="text/css" href="/Style/<?php echo $loginUser !== null ? $loginUser : 'image'; ?>.css">
</head>
<body>
    <!-- 移动端汉堡按钮 -->
    ...
    <div class="category-nav <?php echo $viewMode === 'tree_view' ? 'tree-view' : ''; ?>" id="categoryNav">
        <div class="category-header">
            <h2>简约图库</h2>
            <a href="/user/" class="view-mode-btn"><?php echo $loginUser !== null ? '管理' : '登陆'; ?>图库</a>
    ...
    <div class="gallery-container" id="galleryContainer">
        <div class="gallery-header">
            ...
            <div class="gallery-controls">
                <!-- 搜索 -->
                <input type="text" id="searchInput" class="control-select" placeholder="🔎搜索以加载图片名称..." oninput="onSearchInput()" onkeypress="handleSearchKeyPress(event)">
                <!-- 排序与分组 -->
    ...
    <!-- 脚本文件 -->
    <?php include 'app/part/footer.php'; ?>
