...
<head>
    ...
    <link rel="stylesheet" href="/style/<?php echo $loginUser !== null ? $loginUser : 'image'; ?>.css">
</head>
<body>
    <!-- 移动端汉堡按钮 -->
    ...
    <div class="category-nav" id="categoryNav">
        <div class="category-header">
            <h2>图库管理</h2>
            <a href="<?php echo $loginUser !== null ? 'javascript:logout()' : 'index.php'; ?>" class="view-mode-btn">
                <?php echo $loginUser !== null ? '退出登陆' : '登陆图库'; ?>
            </a>
        ...
        <ul class="category-list">
            <li class="category-item all-items">
                <?php if ($_SESSION['user_info']['role'] !== null): ?>
                <a href="Aplog.php" class="category-link">
                    <span class="category-icon">🖇️</span>
                    API工具
                </a>
                <?php endif; ?>
                <a href="Aplog-key.php" class="category-link active">
    ...
    <div class="gallery-container">
        <div class="container">
            ...
            <a href="index.php" class="btn">⬅返回管理首页</a>
            ...
            <div class="log-section">
                ...
                <form id="apiForm">
                    <div class="form-group">
                        ...
                        <input type="text" id="key" name="key" placeholder="请输入密钥" required value="<?php echo require_once '../app/tool/aesEncrypt.php' ?>">
                        <small class="form-text text-muted">该生成密钥24点准时失效,修改密码等操作依旧失效!</small>
                    </div>
                    <div class="form-group">
