...
<body>
    ...
    <div class="category-nav <?php echo $viewMode === 'tree_view' ? 'tree-view' : ''; ?>" id="categoryNav">
        <div class="category-header">
            ...
            <?php else: ?>
                <a href="/user/" class="view-mode-btn">管理</a>
            <?php endif; ?>
        ...
        <ul class="category-list">
            <li class="category-item all-items">
                ...
                <a href="admin/Aplog.php" class="category-link mobile-all-items-link">
                    <span class="category-icon">🖇️</span>
                    API工具
                </a>
                <a href="admin/settings.php" class="category-link">
                    <span class="category-icon">⚙️</span>
                    系统设置
                </a>
                <?php endif; ?>
    ...
    <!-- 脚本文件 -->
    <?php include 'admin/part/script.php'; ?>
    <?php
        if (!isset($_SESSION['user_info']) || $loginUser === null ){
